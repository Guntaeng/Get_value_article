...
${get_value_section1}    C:/Automate/Web/Get_value_art/resources/get_value_section1.csv
${get_value_section6}    C:/Automate/Web/Get_value_art/resources/get_value_section6.csv
${get_value_section7}    C:/Automate/Web/Get_value_art/resources/get_value_section7.csv
${get_value_section_other}    C:/Automate/Web/Get_value_art/resources/get_value_section_other.csv
...
##############################################################################################################################################################################################################################################################
 ...
 ##############################################################################################################################################################################################################################################################
    ...
    #หน่วย 2
    ${units_id_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='units_id']
    ${units_id_s7_u2_result} =	Get From List	${units_id_s7_u2_base}    0
    ${units_id_s7_u2_value} =	Get From List	${units_id_s7_u2_base}    1

    IF    '${units_id_s7_u2_result}' == 'FAIL'
        ${units_id_s7_u2_result}    Set Variable    -
    ELSE
       ${units_id_s7_u2_result}    Set Variable    ${units_id_s7_u2_value} 
    END
    
    ${units_id_s7_u2}    Set Variable    ${units_id_s7_u2_result}
##############################################################################################################################################################################################################################################################    
    ${width_base_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='width']
    ${width_base_s7_u2_result} =	Get From List	${width_base_s7_u2_base}    0
    ${width_base_s7_u2_value} =	Get From List	${width_base_s7_u2_base}    1

    IF    '${width_base_s7_u2_result}' == 'FAIL'
        ${width_base_s7_u2_result}    Set Variable    -
    ELSE
       ${width_base_s7_u2_result}    Set Variable    ${width_base_s7_u2_value} 
    END
    
    ${width_base_s7_u2}    Set Variable    ${width_base_s7_u2_result}
##############################################################################################################################################################################################################################################################
    ${long_base_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='long']
    ${long_base_s7_u2_result} =	Get From List	${long_base_s7_u2_base}    0
    ${long_base_s7_u2_value} =	Get From List	${long_base_s7_u2_base}    1

    IF    '${long_base_s7_u2_result}' == 'FAIL'
        ${long_base_s7_u2_result}    Set Variable    -
    ELSE
       ${long_base_s7_u2_result}    Set Variable    ${long_base_s7_u2_value} 
    END
    
    ${long_base_s7_u2}    Set Variable    ${long_base_s7_u2_result}
############################################################################################################################################################################################################################################################## 
    ${high_base_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='high']
    ${high_base_s7_u2_result} =	Get From List	${high_base_s7_u2_base}    0
    ${high_base_s7_u2_value} =	Get From List	${high_base_s7_u2_base}    1

    IF    '${high_base_s7_u2_result}' == 'FAIL'
        ${high_base_s7_u2_result}    Set Variable    -
    ELSE
       ${high_base_s7_u2_result}    Set Variable    ${high_base_s7_u2_value} 
    END
    
    ${high_base_s7_u2}    Set Variable    ${high_base_s7_u2_result}
############################################################################################################################################################################################################################################################## 
    ${volume_base_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='volume']
    ${volume_base_s7_u2_result} =	Get From List	${volume_base_s7_u2_base}    0
    ${volume_base_s7_u2_value} =	Get From List	${volume_base_s7_u2_base}    1

    IF    '${volume_base_s7_u2_result}' == 'FAIL'
        ${volume_base_s7_u2_result}    Set Variable    -
    ELSE
       ${volume_base_s7_u2_result}    Set Variable    ${volume_base_s7_u2_value} 
    END
    
    ${volume_base_s7_u2}    Set Variable    ${volume_base_s7_u2_result}
############################################################################################################################################################################################################################################################## 
    ${weight_base_s7_u2_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='2']/parent::div//input[@name='weight']
    ${weight_base_s7_u2_result} =	Get From List	${weight_base_s7_u2_base}    0
    ${weight_base_s7_u2_value} =	Get From List	${weight_base_s7_u2_base}    1

    IF    '${weight_base_s7_u2_result}' == 'FAIL'
        ${weight_base_s7_u2_result}    Set Variable    -
    ELSE
       ${weight_base_s7_u2_result}    Set Variable    ${weight_base_s7_u2_value} 
    END
    
    ${weight_base_s7_u2}    Set Variable    ${weight_base_s7_u2_result}
##############################################################################################################################################################################################################################################################    

    #หน่วย 3
    ${units_id_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='units_id']
    ${units_id_s7_u3_result} =	Get From List	${units_id_s7_u3_base}    0
    ${units_id_s7_u3_value} =	Get From List	${units_id_s7_u3_base}    1

    IF    '${units_id_s7_u3_result}' == 'FAIL'
        ${units_id_s7_u3_result}    Set Variable    -
    ELSE
       ${units_id_s7_u3_result}    Set Variable    ${units_id_s7_u3_value} 
    END
    
    ${units_id_s7_u3}    Set Variable    ${units_id_s7_u3_result}
##############################################################################################################################################################################################################################################################
    ${width_base_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='width']
    ${width_base_s7_u3_result} =	Get From List	${width_base_s7_u3_base}    0
    ${width_base_s7_u3_value} =	Get From List	${width_base_s7_u3_base}    1

    IF    '${width_base_s7_u3_result}' == 'FAIL'
        ${width_base_s7_u3_result}    Set Variable    -
    ELSE
       ${width_base_s7_u3_result}    Set Variable    ${width_base_s7_u3_value} 
    END
    
    ${width_base_s7_u3}    Set Variable    ${width_base_s7_u3_result}
##############################################################################################################################################################################################################################################################
    ${long_base_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='long']
    ${long_base_s7_u3_result} =	Get From List	${long_base_s7_u3_base}    0
    ${long_base_s7_u3_value} =	Get From List	${long_base_s7_u3_base}    1

    IF    '${long_base_s7_u3_result}' == 'FAIL'
        ${long_base_s7_u3_result}    Set Variable    -
    ELSE
       ${long_base_s7_u3_result}    Set Variable    ${long_base_s7_u3_value} 
    END
    
    ${long_base_s7_u3}    Set Variable    ${long_base_s7_u3_result}
##############################################################################################################################################################################################################################################################
    ${high_base_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='high']
    ${high_base_s7_u3_result} =	Get From List	${high_base_s7_u3_base}    0
    ${high_base_s7_u3_value} =	Get From List	${high_base_s7_u3_base}    1

    IF    '${high_base_s7_u3_result}' == 'FAIL'
        ${high_base_s7_u3_result}    Set Variable    -
    ELSE
       ${high_base_s7_u3_result}    Set Variable    ${high_base_s7_u3_value} 
    END
    
    ${high_base_s7_u3}    Set Variable    ${high_base_s7_u3_result}
##############################################################################################################################################################################################################################################################
    ${volume_base_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='volume']
    ${volume_base_s7_u3_result} =	Get From List	${volume_base_s7_u3_base}    0
    ${volume_base_s7_u3_value} =	Get From List	${volume_base_s7_u3_base}    1

    IF    '${volume_base_s7_u3_result}' == 'FAIL'
        ${volume_base_s7_u3_result}    Set Variable    -
    ELSE
       ${volume_base_s7_u3_result}    Set Variable    ${volume_base_s7_u3_value} 
    END
    
    ${volume_base_s7_u3}    Set Variable    ${volume_base_s7_u3_result}
##############################################################################################################################################################################################################################################################
    ${weight_base_s7_u3_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='3']/parent::div//input[@name='weight']
    ${weight_base_s7_u3_result} =	Get From List	${weight_base_s7_u3_base}    0
    ${weight_base_s7_u3_value} =	Get From List	${weight_base_s7_u3_base}    1

    IF    '${weight_base_s7_u3_result}' == 'FAIL'
        ${weight_base_s7_u3_result}    Set Variable    -
    ELSE
       ${weight_base_s7_u3_result}    Set Variable    ${weight_base_s7_u3_value} 
    END
    
    ${weight_base_s7_u3}    Set Variable    ${weight_base_s7_u3_result}
 ##############################################################################################################################################################################################################################################################

    #หน่วย 4
    ${units_id_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='units_id']
    ${units_id_s7_u4_result} =	Get From List	${units_id_s7_u4_base}    0
    ${units_id_s7_u4_value} =	Get From List	${units_id_s7_u4_base}    1

    IF    '${units_id_s7_u4_result}' == 'FAIL'
        ${units_id_s7_u4_result}    Set Variable    -
    ELSE
       ${units_id_s7_u4_result}    Set Variable    ${units_id_s7_u4_value} 
    END
    
    ${units_id_s7_u4}    Set Variable    ${units_id_s7_u4_result}
##############################################################################################################################################################################################################################################################
    ${width_base_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='width']
    ${width_base_s7_u4_result} =	Get From List	${width_base_s7_u4_base}    0
    ${width_base_s7_u4_value} =	Get From List	${width_base_s7_u4_base}    1

    IF    '${width_base_s7_u4_result}' == 'FAIL'
        ${width_base_s7_u4_result}    Set Variable    -
    ELSE
       ${width_base_s7_u4_result}    Set Variable    ${width_base_s7_u4_value} 
    END
    
    ${width_base_s7_u4}    Set Variable    ${width_base_s7_u4_result}
##############################################################################################################################################################################################################################################################
    ${long_base_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='long']
    ${long_base_s7_u4_result} =	Get From List	${long_base_s7_u4_base}    0
    ${long_base_s7_u4_value} =	Get From List	${long_base_s7_u4_base}    1

    IF    '${long_base_s7_u4_result}' == 'FAIL'
        ${long_base_s7_u4_result}    Set Variable    -
    ELSE
       ${long_base_s7_u4_result}    Set Variable    ${long_base_s7_u4_value} 
    END
    
    ${long_base_s7_u4}    Set Variable    ${long_base_s7_u4_result}
##############################################################################################################################################################################################################################################################
    ${high_base_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='high']
    ${high_base_s7_u4_result} =	Get From List	${high_base_s7_u4_base}    0
    ${high_base_s7_u4_value} =	Get From List	${high_base_s7_u4_base}    1

    IF    '${high_base_s7_u4_result}' == 'FAIL'
        ${high_base_s7_u4_result}    Set Variable    -
    ELSE
       ${high_base_s7_u4_result}    Set Variable    ${high_base_s7_u4_value} 
    END
    
    ${high_base_s7_u4}    Set Variable    ${high_base_s7_u4_result}
##############################################################################################################################################################################################################################################################
    ${volume_base_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='volume']
    ${volume_base_s7_u4_result} =	Get From List	${volume_base_s7_u4_base}    0
    ${volume_base_s7_u4_value} =	Get From List	${volume_base_s7_u4_base}    1

    IF    '${volume_base_s7_u4_result}' == 'FAIL'
        ${volume_base_s7_u4_result}    Set Variable    -
    ELSE
       ${volume_base_s7_u4_result}    Set Variable    ${volume_base_s7_u4_value} 
    END
    
    ${volume_base_s7_u4}    Set Variable    ${volume_base_s7_u4_result}
##############################################################################################################################################################################################################################################################
    ${weight_base_s7_u4_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='4']/parent::div//input[@name='weight']
    ${weight_base_s7_u4_result} =	Get From List	${weight_base_s7_u4_base}    0
    ${weight_base_s7_u4_value} =	Get From List	${weight_base_s7_u4_base}    1

    IF    '${weight_base_s7_u4_result}' == 'FAIL'
        ${weight_base_s7_u4_result}    Set Variable    -
    ELSE
       ${weight_base_s7_u4_result}    Set Variable    ${weight_base_s7_u4_value} 
    END
    
    ${weight_base_s7_u4}    Set Variable    ${weight_base_s7_u4_result}
 ##############################################################################################################################################################################################################################################################

    #หน่วย 5
    ${units_id_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='units_id']
    ${units_id_s7_u5_result} =	Get From List	${units_id_s7_u5_base}    0
    ${units_id_s7_u5_value} =	Get From List	${units_id_s7_u5_base}    1

    IF    '${units_id_s7_u5_result}' == 'FAIL'
        ${units_id_s7_u5_result}    Set Variable    -
    ELSE
       ${units_id_s7_u5_result}    Set Variable    ${units_id_s7_u5_value} 
    END
    
    ${units_id_s7_u5}    Set Variable    ${units_id_s7_u5_result}
##############################################################################################################################################################################################################################################################
    ${width_base_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='width']
    ${width_base_s7_u5_result} =	Get From List	${width_base_s7_u5_base}    0
    ${width_base_s7_u5_value} =	Get From List	${width_base_s7_u5_base}    1

    IF    '${width_base_s7_u5_result}' == 'FAIL'
        ${width_base_s7_u5_result}    Set Variable    -
    ELSE
       ${width_base_s7_u5_result}    Set Variable    ${width_base_s7_u5_value} 
    END
    
    ${width_base_s7_u5}    Set Variable    ${width_base_s7_u5_result}
##############################################################################################################################################################################################################################################################
    ${long_base_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='long']
    ${long_base_s7_u5_result} =	Get From List	${long_base_s7_u5_base}    0
    ${long_base_s7_u5_value} =	Get From List	${long_base_s7_u5_base}    1

    IF    '${long_base_s7_u5_result}' == 'FAIL'
        ${long_base_s7_u5_result}    Set Variable    -
    ELSE
       ${long_base_s7_u5_result}    Set Variable    ${long_base_s7_u5_value} 
    END
    
    ${long_base_s7_u5}    Set Variable    ${long_base_s7_u5_result}
##############################################################################################################################################################################################################################################################
    ${high_base_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='high']
    ${high_base_s7_u5_result} =	Get From List	${high_base_s7_u5_base}    0
    ${high_base_s7_u5_value} =	Get From List	${high_base_s7_u5_base}    1

    IF    '${high_base_s7_u5_result}' == 'FAIL'
        ${high_base_s7_u5_result}    Set Variable    -
    ELSE
       ${high_base_s7_u5_result}    Set Variable    ${high_base_s7_u5_value} 
    END
    
    ${high_base_s7_u5}    Set Variable    ${high_base_s7_u5_result}
##############################################################################################################################################################################################################################################################
    ${volume_base_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='volume']
    ${volume_base_s7_u5_result} =	Get From List	${volume_base_s7_u5_base}    0
    ${volume_base_s7_u5_value} =	Get From List	${volume_base_s7_u5_base}    1

    IF    '${volume_base_s7_u5_result}' == 'FAIL'
        ${volume_base_s7_u5_result}    Set Variable    -
    ELSE
       ${volume_base_s7_u5_result}    Set Variable    ${volume_base_s7_u5_value} 
    END
    
    ${volume_base_s7_u5}    Set Variable    ${volume_base_s7_u5_result}
##############################################################################################################################################################################################################################################################
    ${weight_base_s7_u5_base}=    Run Keyword And Ignore Error            Get Value       //*[text()='7. หน่วยสินค้า , ขนาด,บาร์โค๊ด ไม่รวมแพคกิ้ง']/parent::div/parent::div/following-sibling::*[2]//*[text()='5']/parent::div//input[@name='weight']
    ${weight_base_s7_u5_result} =	Get From List	${weight_base_s7_u5_base}    0
    ${weight_base_s7_u5_value} =	Get From List	${weight_base_s7_u5_base}    1

    IF    '${weight_base_s7_u5_result}' == 'FAIL'
        ${weight_base_s7_u5_result}    Set Variable    -
    ELSE
       ${weight_base_s7_u5_result}    Set Variable    ${weight_base_s7_u5_value} 
    END
    
    ${weight_base_s7_u5}    Set Variable    ${weight_base_s7_u5_result}
 ##############################################################################################################################################################################################################################################################
    ...
    #${data_article}    Set Variable    ${data_section_7}


    #Append To File    ${value_art}    ${data_article}\n

    #Append To File    ${get_value_section1}    ${data_section_1}\n

    #Append To File    ${get_value_section6}    ${data_section_6}\n

    #Append To File    ${get_value_section7}    ${data_section_7}\n
    
    Append To File    ${get_value_section_other}    ${section_2},${section_3},${section_4},${section_5},${section_12},${section_14}\n